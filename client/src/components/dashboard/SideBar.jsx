...
const SideBar = ({isOpen}) => {
    return (
        <aside id="default-sidebar" className={`fixed top-[10vh] left-0 w-64 h-[90vh] transition-transform -translate-x-full ${isOpen ? "translate-x-0" : ""}`} aria-label="Sidebar">
